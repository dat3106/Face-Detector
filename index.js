...
const loadFaceAPI = async () => {
    await faceapi.nets.faceLandmark68Net.loadFromUri('./models') // cac moc khuon mat
    await faceapi.nets.faceRecognitionNet.loadFromUri('./models') // nhan dang khuon mat
    await faceapi.nets.tinyFaceDetector.loadFromUri('./models') // do mat
    await faceapi.nets.faceExpressionNet.loadFromUri('./models') // du doan bieu cam
